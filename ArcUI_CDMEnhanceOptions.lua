...
function ns.GetCDMAuraIconsOptionsTable()
  local args = {
    ...
    rangeEnabled = {
      ...
      desc = "Show the out-of-range darkening overlay",
    ...
    rangeAlpha = {
      type = "range", name = "Overlay Intensity", min = 0, max = 1.0, step = 0.05,
      desc = "How dark icons appear when out of range",
      get = function() local c = GetAuraCfg(); return c and c.rangeIndicator and c.rangeIndicator.alpha or 0.6 end,
      set = function(_, v) ApplyAuraSetting(function(c) if c.rangeIndicator then c.rangeIndicator.alpha = v end end) end,
      order = 108.2, width = 0.85, hidden = HideAuraRangeIndicator,
    },
    rangeDesaturate = {
      type = "toggle", name = "Desaturate Icon",
      desc = "Make icon grayscale when out of range",
      get = function() return GetAuraBoolSetting(function(c) return c and c.rangeIndicator and c.rangeIndicator.desaturate end, function() local c = GetAuraCfg(); return c and c.rangeIndicator and c.rangeIndicator.desaturate end) end,
      set = function(_, v) ApplyAuraSetting(function(c) if c.rangeIndicator then c.rangeIndicator.desaturate = v end end) end,
      order = 108.3, width = 0.85, hidden = HideAuraRangeIndicator,
    },
    resetRangeIndicator = {
      type = "execute",
      name = "Reset Section",
    ...
    procGlowType = {
      ...
      desc = "Select the glow animation style\n\n|cffffd700Proc|r - Flashy proc effect (default)\n|cffffd700Pixel|r - Rotating pixel lines\n|cffffd700AutoCast|r - Sparkle particles\n|cffffd700Button|r - Classic button glow",
      values = {
        ["pixel"] = "Pixel Glow",
        ["autocast"] = "AutoCast Sparkles",
        ["button"] = "Button Glow",
        ["proc"] = "Proc Effect (Default)",
      },
      sorting = {"proc", "pixel", "autocast", "button"},
      get = function() local c = GetAuraCfg(); return c and c.procGlow and c.procGlow.glowType or "proc" end,
    ...
    procGlowColor = {
      ...
      order = 109.2, width = 0.55, hidden = HideAuraProcGlow,
    },
    procGlowAlpha = {
      ...
      order = 109.25, width = 0.6, hidden = HideAuraProcGlow,
    },
    procGlowScale = {
      type = "range", name = "Scale", min = 0.25, max = 4.0, step = 0.05,
      desc = "Size of the glow effect",
      ...
      hidden = function()
        ...
        local c = GetAuraCfg()
        return not (c and c.procGlow and c.procGlow.glowType == "autocast")
      end,
    },
    procGlowSpeed = {
      ...
      hidden = function()
        ...
        local c = GetAuraCfg()
        -- Proc glow doesn't use speed
        return c and c.procGlow and c.procGlow.glowType == "proc"
      end,
    },
    procGlowLines = {
      ...
      hidden = function()
        if HideAuraProcGlow() then return true end
        local c = GetAuraCfg()
        return not (c and c.procGlow and c.procGlow.glowType == "pixel")
      end,
    },
    procGlowThickness = {
...
function ns.GetCDMCooldownIconsOptionsTable()
  local args = {
    ...
    rangeAlpha = {
      type = "range", name = "Overlay Intensity", min = 0, max = 1.0, step = 0.05,
      desc = "How dark icons appear when out of range",
      get = function() local c = GetCooldownCfg(); return c and c.rangeIndicator and c.rangeIndicator.alpha or 0.6 end,
      set = function(_, v) ApplySharedCooldownSetting(function(c) if c.rangeIndicator then c.rangeIndicator.alpha = v end end) end,
      order = 108.2, width = 0.85, hidden = HideCooldownRangeIndicator,
    },
    rangeDesaturate = {
      type = "toggle", name = "Desaturate Icon",
      desc = "Make icon grayscale when out of range",
      get = function() return GetCooldownBoolSetting(function(c) return c and c.rangeIndicator and c.rangeIndicator.desaturate end, function() local c = GetCooldownCfg(); return c and c.rangeIndicator and c.rangeIndicator.desaturate end) end,
      set = function(_, v) ApplySharedCooldownSetting(function(c) if c.rangeIndicator then c.rangeIndicator.desaturate = v end end) end,
      order = 108.3, width = 0.85, hidden = HideCooldownRangeIndicator,
    },
    resetRangeIndicator = {
      type = "execute",
      name = "Reset Section",
    ...
    procGlowType = {
      ...
      sorting = {"proc", "pixel", "autocast", "button"},
      get = function() local c = GetCooldownCfg(); return c and c.procGlow and c.procGlow.glowType or "proc" end,
    ...
    procGlowColor = {
      ...
      order = 109.2, width = 0.55, hidden = HideCooldownProcGlow,
    },
    procGlowAlpha = {
      type = "range", name = "Intensity", min = 0, max = 1.0, step = 0.05,
      desc = "How bright the glow appears",
      ...
      order = 109.25, width = 0.6, hidden = HideCooldownProcGlow,
    },
    procGlowScale = {
      type = "range", name = "Scale", min = 0.25, max = 4.0, step = 0.05,
      desc = "Size of the glow effect",
  ...
  return {
    ...
    args = {
      ...
      swipeColorEnabled = {
        ...
        set = function(_, v)
          if v then
            ApplyAuraGlobalSetting("cooldownSwipe.swipeColor", {0, 0, 0, 0.8})
          else
      ...
      swipeColor = {
        ...
        get = function()
          ...
          if c then return c[1] or 0, c[2] or 0, c[3] or 0, c[4] or 0.8 end
          return 0, 0, 0, 0.8
        end,
        set = function(_, r, g, b, a)
          ApplyAuraGlobalSetting("cooldownSwipe.swipeColor", {r, g, b, a}); RefreshGlobalAuras()
        end,
        order = 27, width = 0.5,
        hidden = function()
      ...
      edgeColorEnabled = {
        ...
        set = function(_, v)
          if v then
            ApplyAuraGlobalSetting("cooldownSwipe.edgeColor", {1, 1, 1, 1})
          else
      ...
      edgeColor = {
        ...
        set = function(_, r, g, b, a)
          ApplyAuraGlobalSetting("cooldownSwipe.edgeColor", {r, g, b, a}); RefreshGlobalAuras()
        end,
      ...
      glowType = {
        ...
        values = { pixel = "Pixel", autocast = "Autocast", button = "Button", proc = "Proc (Default)" },
        sorting = {"proc", "pixel", "autocast", "button"},
        get = function() local g = GetAuraGlobalCfg(); return g.procGlow and g.procGlow.glowType or "proc" end,
      ...
      glowColor = {
        ...
        order = 52.5, width = 0.4, hidden = function() return collapsedGlobalAuraSections.procGlow end,
      },
      glowAlpha = {
        type = "range", name = "Intensity", min = 0, max = 1.0, step = 0.05,
        desc = "How bright the glow appears",
        ...
        order = 52.6, width = 0.5, hidden = function() return collapsedGlobalAuraSections.procGlow end,
      },
      glowScale = {
        ...
        order = 53, width = 0.5, hidden = function() return collapsedGlobalAuraSections.procGlow end,
      },
      glowSpeed = {
        type = "range", name = "Speed", min = 0.05, max = 1.0, step = 0.05,
        ...
        hidden = function() return collapsedGlobalAuraSections.procGlow end,
      },
      glowLines = {
        type = "range", name = "Lines", min = 1, max = 16, step = 1,
        desc = "Number of glow lines",
        ...
        hidden = function()
          ...
          local g = GetAuraGlobalCfg()
          return not (g.procGlow and g.procGlow.glowType == "pixel")
        end,
      },
      glowThickness = {
        type = "range", name = "Thickness", min = 1, max = 10, step = 0.5,
      ...
      glowParticles = {
        ...
        hidden = function()
          if collapsedGlobalAuraSections.procGlow then return true end
          local g = GetAuraGlobalCfg()
          return not (g.procGlow and g.procGlow.glowType == "autocast")
        end,
      },
      ...
      rangeEnabled = {
        ...
        order = 61, width = 0.5, hidden = function() return collapsedGlobalAuraSections.rangeIndicator end,
      },
      rangeAlpha = {
        type = "range", name = "Alpha", min = 0, max = 1.0, step = 0.05,
        get = function() local g = GetAuraGlobalCfg(); return g.rangeIndicator and g.rangeIndicator.alpha or 0.6 end,
        set = function(_, v) ApplyAuraGlobalSetting("rangeIndicator.alpha", v); RefreshGlobalAuras() end,
        order = 62, width = 0.7, hidden = function() return collapsedGlobalAuraSections.rangeIndicator end,
      },
      rangeDesaturate = {
        type = "toggle", name = "Desaturate",
        get = function() local g = GetAuraGlobalCfg(); return g.rangeIndicator and g.rangeIndicator.desaturate end,
        set = function(_, v) ApplyAuraGlobalSetting("rangeIndicator.desaturate", v); RefreshGlobalAuras() end,
        order = 63, width = 0.6, hidden = function() return collapsedGlobalAuraSections.rangeIndicator end,
      },
  ...
  return {
    ...
    args = {
      ...
      swipeColorEnabled = {
        ...
        set = function(_, v)
          if v then
            ApplyCooldownGlobalSetting("cooldownSwipe.swipeColor", {0, 0, 0, 0.8})
          else
      ...
      swipeColor = {
        ...
        set = function(_, r, gc, b, a)
          ApplyCooldownGlobalSetting("cooldownSwipe.swipeColor", {r, gc, b, a}); RefreshGlobalCooldowns()
        end,
        order = 27, width = 0.5,
        hidden = function()
      ...
      glowType = {
        ...
        values = { pixel = "Pixel", autocast = "Autocast", button = "Button", proc = "Proc (Default)" },
        sorting = {"proc", "pixel", "autocast", "button"},
        get = function() local g = GetCooldownGlobalCfg(); return g.procGlow and g.procGlow.glowType or "proc" end,
      ...
      glowColor = {
        ...
        order = 52.5, width = 0.4, hidden = function() return collapsedGlobalCooldownSections.procGlow end,
      },
      glowAlpha = {
        type = "range", name = "Intensity", min = 0, max = 1.0, step = 0.05,
        desc = "How bright the glow appears",
        ...
        order = 52.6, width = 0.5, hidden = function() return collapsedGlobalCooldownSections.procGlow end,
      },
      glowScale = {
        type = "range", name = "Scale", min = 0.25, max = 4.0, step = 0.05, isPercent = true,
        ...
        order = 53, width = 0.5, hidden = function() return collapsedGlobalCooldownSections.procGlow end,
      },
      glowSpeed = {
        type = "range", name = "Speed", min = 0.05, max = 1.0, step = 0.05,
        desc = "Animation speed",
        ...
        order = 53.5, width = 0.5,
        hidden = function() return collapsedGlobalCooldownSections.procGlow end,
      },
      glowLines = {
        type = "range", name = "Lines", min = 1, max = 16, step = 1,
        desc = "Number of glow lines",
      ...
      rangeEnabled = {
        ...
        order = 61, width = 0.5, hidden = function() return collapsedGlobalCooldownSections.rangeIndicator end,
      },
      rangeAlpha = {
        type = "range", name = "Alpha", min = 0, max = 1.0, step = 0.05,
        get = function() local g = GetCooldownGlobalCfg(); return g.rangeIndicator and g.rangeIndicator.alpha or 0.6 end,
        set = function(_, v) ApplyCooldownGlobalSetting("rangeIndicator.alpha", v); RefreshGlobalCooldowns() end,
        order = 62, width = 0.7, hidden = function() return collapsedGlobalCooldownSections.rangeIndicator end,
      },
      rangeDesaturate = {
        type = "toggle", name = "Desaturate",
        get = function() local g = GetCooldownGlobalCfg(); return g.rangeIndicator and g.rangeIndicator.desaturate end,
        set = function(_, v) ApplyCooldownGlobalSetting("rangeIndicator.desaturate", v); RefreshGlobalCooldowns() end,
        order = 63, width = 0.6, hidden = function() return collapsedGlobalCooldownSections.rangeIndicator end,
      },
